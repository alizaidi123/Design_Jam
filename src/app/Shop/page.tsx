    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute top-[15%] sm:top-[25%] left-[50%] transform -translate-x-1/2 flex flex-col items-center text-center">
          ...
          />
          <h3 className="text-2xl sm:text-4xl font-semibold font-poppins">Shop</h3>
        ...
        {data.map((card, index) => (
          ...
          >
            ...
            <div className="card-body p-4">
              <h5 className="card-title font-bold font-poppins text-lg sm:text-xl">{card.name}</h5>
              <p className="card-text text-gray-600 font-poppins text-sm sm:text-base">{card.description}</p>
              <h5 className="card-title font-bold text-lg sm:text-xl mt-2 font-poppins">{card.price}</h5>
            </div>
          </div>
        ))}
      </div>
